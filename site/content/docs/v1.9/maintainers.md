...
- There are some [code standards and general guidelines](https://velero.io/docs/v1.9.0/code-standards) we aim for
- We have [guidelines for writing and reviewing documentation](https://velero.io/docs/v1.9.0/style-guide/)
