...
func TestSnapshotSource(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			args: []mockArgs{
				{methodName: "LoadSnapshot", returns: []interface{}{manifest2, errors.New("failed to load snapshot")}},
				{methodName: "SaveSnapshot", returns: []interface{}{manifest2.ID, nil}},
				{methodName: "TreeForSource", returns: []interface{}{nil, nil}},
				{methodName: "ApplyRetentionPolicy", returns: []interface{}{nil, nil}},
				{methodName: "SetPolicy", returns: []interface{}{nil}},
				{methodName: "Upload", returns: []interface{}{manifest2, nil}},
				{methodName: "Flush", returns: []interface{}{nil}},
			},
			notError: false,
		},
