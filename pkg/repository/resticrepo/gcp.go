...
// GetGCPRepositoryEnvVars gets the environment variables that repository relies
// on based on info in the provided object storage location config map.
func GetGCPRepositoryEnvVars(config map[string]string) (map[string]string, error) {
