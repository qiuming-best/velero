...
// GetAzureRepositoryEnvVars gets the environment variables that repository
// relies on (AZURE_ACCOUNT_NAME and AZURE_ACCOUNT_KEY) based
// on info in the provided object storage location config map.
func GetAzureRepositoryEnvVars(config map[string]string) (map[string]string, error) {
