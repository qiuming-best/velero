...
func (c *FakeVeleroV1) SnapshotBackups(namespace string) v1.SnapshotBackupInterface {
	return &FakeSnapshotBackups{c, namespace}
}

func (c *FakeVeleroV1) SnapshotRestores(namespace string) v1.SnapshotRestoreInterface {
